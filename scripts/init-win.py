...
def setup_sshd_qemu(vm_ip: str = "10.0.2.4"):
    ...
    f = home_directory / "Public" / "setup-openssh.ps1"
    s = Path.cwd() / ".." / "scripts" / "install-openssh.ps1"
    s = s.resolve().absolute()
    _ = shutil.copy(s, f)
    ...
    try:
        ...
        sendkey_sequence(
            ...
            [
                ...
                send_word_keys(rf" . \\{vm_ip}\qemu\setup-openssh.ps1"),
                "ret",
            ],
            delay=0,
        )
